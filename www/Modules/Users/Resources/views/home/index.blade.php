...
{{--    @include('users::home.flashsale')--}}

{{--    @include('users::home.hotdeal')--}}
...
{{--    @include('users::home.featured_category')--}}

{{--    @include('users::home.covenient_service')--}}

{{--    @include('users::home.orther')--}}
</section>
