                ...
                <div class="row">
                    <div class="row-input-group col-6 form-group">
                        ...
                        <input type="text" class="form-control" name="name"
                            value="{{ old('name') ?? $product->name }}" placeholder="Nhập địa chỉ mail . . ." />
                        @error('name')
                    ...
                    <div class="row-input-group col-6 form-group">
                        ...
                        <select class="form-control" name="category_id">
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->id }}" @selected($product->category_id == $category->id || old('category_id') == $category->id)>
                                    {{ $category->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="row-input-group col-6 form-group">
                        ...
                        <input type="text" class="form-control" name="promotional_price"
                            value="{{ old('promotional_price') }}" placeholder="Nhập địa chỉ mail . . ." />
